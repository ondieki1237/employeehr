    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-sm leading-6" style={{ color: branding.textColor + "cc" }}>
          Track invoices, payments, balances, and financial reporting.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Button
          ...
          className="border"
        >
          <Link href="#">Outstanding Balances</Link>
        </Button>
      </div>

      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {[
          { title: "Invoices", description: "Create and manage student fee invoices and billing records." },
          { title: "Payments", description: "Record fee payments and manage payment records." },
          { title: "Reporting", description: "Generate fee reports and track outstanding balances." },
        ].map((item) => (
          <Card
            key={item.title}
