    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-sm leading-6" style={{ color: branding.textColor + "cc" }}>
          Create exams, manage sittings, record results, and track performance.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {[
          { title: "Create Exam", description: "Set up new examination sittings and manage exam schedules." },
          { title: "Record Results", description: "Enter exam results and generate performance analytics." },
          { title: "Analysis", description: "Review performance trends and generate examination reports." },
        ].map((item) => (
          <Card
            key={item.title}
